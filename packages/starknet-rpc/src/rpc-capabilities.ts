...
export class StarknetRpcCapabilities {
  ...
  readonly eventIndices: boolean;
  readonly stateAddressFiltering: boolean;
  readonly responseFlags: boolean;
  ...
  private constructor(readonly specVersion: string) {
    ...
    const rpc010 = gte(version, "0.10.0");
    ...
    this.subscriptions = {
      ...
      events: rpc08,
      reorgNotifications: rpc08,
    };
    this.multiAddressEvents = rpc0101;
    this.eventIndices = rpc010;
    this.stateAddressFiltering = rpc0101;
    this.responseFlags = rpc0101;
  }
